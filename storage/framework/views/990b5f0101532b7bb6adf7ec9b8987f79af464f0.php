    ...
    <div class="container">
      <div class=table>
        ...
        <table>
          ...
          <tr>
            <td><?php echo e($i->Pet); ?></td>
            <td><?php echo e($i->Category); ?></td>
            <td><?php echo e($i->Reason); ?></td>
            <td><?php echo e($i->Email); ?></td>
            <td><?php echo e($i->Vaccination); ?></td>
            <td><a href="adminsurrender/<?php echo e($i->User_Id); ?>" class="btn btn-danger">Delete</a></td>
          </tr>
...
</html><?php /**PATH E:\laravel\project\resources\views//adminsurrender.blade.php ENDPATH**/ ?>